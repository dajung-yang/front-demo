...
const getFeatures = (theme: string): Feature[] => [
    ...
    },
    {
        ...
        subheader:
            "We also have included all the necessary layouts for a startup.",
        title: "Landing Pages"
    }
];
                ...
                <Grid container spacing={3}>
                    <Grid item md={6} xs={12}>
                        ...
                        <Typography
                            ...
                            variant="subtitle1"
                        >
                            Comes packed with 21 custom templates and many
                            individual components built to meet almost any type
                            of admin or customer application requirements.
                        </Typography>
